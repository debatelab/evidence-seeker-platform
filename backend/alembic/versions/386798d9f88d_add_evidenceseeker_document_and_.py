...
def upgrade() -> None:
    ...
    if not inspector.has_table("users"):
        op.create_table(
            ...
            sa.Column(
                "hashed_password", sa.VARCHAR(), autoincrement=False, nullable=False
            ),
    ...
    if not inspector.has_table("evidence_seekers"):
        op.create_table(
            "evidence_seekers",
            sa.Column("id", sa.INTEGER(), autoincrement=True, nullable=False),
            sa.Column(
        ...
        op.create_index(
            "ix_evidence_seekers_id", "evidence_seekers", ["id"], unique=False
        )
        op.create_index(
    ...
    if not inspector.has_table("documents"):
        op.create_table(
            ...
            sa.Column(
                "title", sa.VARCHAR(length=200), autoincrement=False, nullable=False
            ),
            sa.Column("description", sa.TEXT(), autoincrement=False, nullable=True),
            sa.Column(
